...
public class UpdateBasketballRes {
    ...
    @Builder
    public UpdateBasketballRes(Long gameId, Long benefitId, Long storeId, Integer timeLimit, Integer ballCount, Integer successCount, String benefitContent, BenefitType benefitType) {
        this.gameId = gameId;
